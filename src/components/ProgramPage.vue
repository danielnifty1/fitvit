...
<template>
  ...
  <div
  class="grid md:grid-cols-3 content-between w-full px-10 md:px-24  gap-y-3   h-auto" style="background-image: url(svg/effect-1.svg);"  
  >
